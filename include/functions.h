...
void Matrix_RotateX_S(s16 rotation, s32 appendToState);
void Matrix_RotateX_F(f32 rotation, s32 appendToState);
void Matrix_RotateStateAroundXAxis(f32 rotation);
void Matrix_SetStateXRotation(f32 rotation);
void Matrix_RotateY_S(s16 rotation, u8 appendToState);
void Matrix_RotateY_F(f32 rotation, s32 appendToState);
void Matrix_RotateZ_S(s16 rotation, s32 appendToState);
void Matrix_RotateZ_F(f32 rotation, s32 appendToState);
void Matrix_RotateRPY(s16 xRotation, s16 yRotation, s16 zRotation, s32 appendToState);
