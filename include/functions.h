...
void StartHeap_AnalyzeArena(size_t* maxFreeBlock, size_t* bytesFree, size_t* bytesAllocated);
...
void func_8013E3B8(Actor* actor, UNK_TYPE arg1, UNK_TYPE arg2);
...
Mtx* Matrix_ToRSPMatrix(MtxF* src, Mtx* dst);
