...
void func_80B47BAC(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, this->bankIndex)) {
        ...
        SkelAnime_InitFlex(globalCtx, &this->skelAnime, &D_06004E50, &D_06001D80, this->limbDrawTable,
                         this->morphTable, 14);
...
void func_80B47FA8(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, this->bankIndex)) {
        ...
        SkelAnime_InitFlex(globalCtx, &this->skelAnime, &D_06004010, NULL, this->limbDrawTable, this->morphTable,
                         6);
...
void func_80B481C4(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, this->bankIndex)) {
        ...
        SkelAnime_InitFlex(globalCtx, &this->skelAnime, &D_06004C30, NULL, this->limbDrawTable, this->morphTable,
                         6);
...
void func_80B48620(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, this->bankIndex)) {
        ...
        SkelAnime_InitFlex(globalCtx, &this->skelAnime, &D_06013928, &D_06009E58, this->limbDrawTable,
                         this->morphTable, 23);
...
void func_80B48848(EnInvadepoh* this, GlobalContext* globalCtx) {
    ...
    if (((this->actor.flags & 0x40) == 0x40) && (Animation_OnFrame(&this->skelAnime, 0.0f) || Animation_OnFrame(&this->skelAnime, 7.0f))) {
...
void func_80B49F88(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, this->bankIndex)) {
        ...
        Actor_SetObjectSegment(globalCtx, &this->actor);
        func_80B44F58();
        SkelAnime_InitFlex(globalCtx, &this->skelAnime, &D_06013928, &D_06014088, this->limbDrawTable,
                         this->morphTable, 23);
...
void func_80B4B8BC(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, this->bankIndex)) {
        this->actor.objBankIndex = this->bankIndex;
        Actor_SetObjectSegment(globalCtx, &this->actor);
        SkelAnime_InitFlex(globalCtx, &this->skelAnime, &D_060080F0, &D_060021C8, this->limbDrawTable,
                         this->morphTable, 13);
...
void func_80B4BC4C(EnInvadepoh* this, GlobalContext* globalCtx) {
    ...
    if (((this->actor.flags & 0x40) == 0x40) && (Animation_OnFrame(&this->skelAnime, 0.0f) || Animation_OnFrame(&this->skelAnime, 12.0f))) {
        Audio_PlayActorSound2(&this->actor, NA_SE_EN_ROMANI_WALK);
    }
...
void func_80B4C3A0(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, this->bankIndex)) {
        ...
        Actor_SetObjectSegment(globalCtx, &this->actor);
        func_80B44FEC();
        SkelAnime_InitFlex(globalCtx, &this->skelAnime, &D_06015C28, &D_06016720, (0, this->limbDrawTable),
                         this->morphTable, 22);
...
void func_80B4D670(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (Object_IsLoaded(&globalCtx->objectCtx, this->bankIndex)) {
        ...
        SkelAnime_InitFlex(globalCtx, &this->skelAnime, &D_06004E50, &D_06001674, this->limbDrawTable,
                         this->morphTable, 14);
        if (invadepohType < 3) {
...
void func_80B4DB14(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->drawAlien) {
        ...
        if (this->alienAlpha == 255) {
            ...
            spCC->polyOpa.p = SkelAnime_DrawSV2(globalCtx, this->skelAnime.skeleton, this->skelAnime.jointTable,
            ...
            spCC->polyXlu.p = SkelAnime_DrawSV2(globalCtx, this->skelAnime.skeleton, this->skelAnime.jointTable,
                                                this->skelAnime.dListCount, func_80B4D9D8, func_80B4D9F4, &this->actor,
                                                spCC->polyXlu.p);
        }
